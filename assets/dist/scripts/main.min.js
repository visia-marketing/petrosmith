    ...
    'common': {
      init: function init() {
        ...
        if (document.querySelector('.petro-animated-number')) {
          var animatedNumbers = document.querySelectorAll('.petro-animated-number .number-span');
          //var delay = 100; // initial delay in milliseconds

          animatedNumbers.forEach(function (element) {
            var targetNumber = element.getAttribute('data-target');
            var delayMs = element.getAttribute('data-delay');
            var startVal = element.getAttribute('data-start') || 0;
        ...
        new simplelightbox__WEBPACK_IMPORTED_MODULE_3__["default"]('.some-element a', {/* options */});
      },
